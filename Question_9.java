...
public class Question_9 {
	...
	/*
		 ...
		 * strings. he has a large number of text emails, going trough all of them will
		 ...
		 * output "read this mail" else it will output "dont read".
		 * 
		 * for example: a = "dear alejandro.....alot of text" 
